/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2af6e0b6d493f40fb7828617d8a17fc2)
// Runtime types generated with workerd@1.20260918.1 2026-09-18 global_fetch_strictly_public
interface __BaseEnv_Env {
	ASTRO_TEST_KV: KVNamespace;
	astro_d1_demo: D1Database;
	ASSETS: Fetcher;
	ASTRO_TEST_VAR: "Hello from Astro!";
	ASTRO_TEST_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ASTRO_TEST_VAR" | "ASTRO_TEST_SECRET">> {}
}
